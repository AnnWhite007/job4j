...
public class Departments {
    ...
    public static List<String> fillGaps(List<String> deps) {
        //Промежуточная коллекция LinkedHashSet позволяет устранить дубликаты из коллекции, которые будут получаться в результате последовательного складывания единичных департаментов
    ...
    public static void sortAsc(List<String> orgs) {
        // классическая сортировка по возрастанию
