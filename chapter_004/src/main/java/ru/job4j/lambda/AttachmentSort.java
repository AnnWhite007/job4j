 ...
 * Позволяет не засорять папки проекта лишними файлами.
 * После имени класса мы указываем фигурные скобки.
 * Внутри фигурных скобок содержится тело нового класса (методы, поля).
